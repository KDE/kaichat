...
KAIChatUserFeedbackProvider::KAIChatUserFeedbackProvider(QObject *parent)
    : KUserFeedback::Provider(parent)
{
    setProductIdentifier(u"org.kde.kaichat"_s);
...
KAIChatUserFeedbackProvider::~KAIChatUserFeedbackProvider() = default;

#include "moc_kaichatuserfeedbackprovider.cpp"
