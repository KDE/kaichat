...
class LIBKAICHATWIDGETS_TESTS_EXPORT JsonPlainTextEditor : public TextCustomEditor::PlainTextEditor
{
    Q_OBJECT
public:
...
class LIBKAICHATWIDGETS_TESTS_EXPORT JsonPlainTextEditWidget : public QWidget
{
    Q_OBJECT
public:
