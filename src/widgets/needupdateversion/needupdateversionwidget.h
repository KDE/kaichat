 ...
 */
class LIBKAICHATWIDGETS_TESTS_EXPORT NeedUpdateVersionWidget : public KMessageWidget
{
    Q_OBJECT
public:
...
private:
    LIBKAICHATWIDGETS_NO_EXPORT void slotDisableVersionCheck();
    LIBKAICHATWIDGETS_NO_EXPORT void slotCheckNewVersion();
};
